...
using Core.Commands.WorkflowOutcome.GetWorkflowOutcomes;
...
public partial class TestSetup
{
    ...
    public async Task GetOutcomes_ExistingWorkflowWithOutcomes_ShouldSucceed()
    {
        ...
        var getOutcomesHandler = new GetWorkflowOutcomesHandler(_context);
        var getOutcomesRequest = new GetWorkflowOutcomesRequest(workflowId);
        ...
        result.Value.Select(o => o.WorkflowOutcomeId).Should().BeEquivalentTo(expectedOutcomeIds);
    ...
    public async Task GetOutcomes_NonExistentWorkflow_ShouldReturnEmptyList()
    {
        ...
        var getOutcomesHandler = new GetWorkflowOutcomesHandler(_context);
        var getOutcomesRequest = new GetWorkflowOutcomesRequest(nonExistentWorkflowId);
    ...
    public async Task GetOutcomes_MultipleWorkflows_ShouldReturnCorrectOutcomes()
    {
        ...
        var getOutcomesHandler = new GetWorkflowOutcomesHandler(_context);
        var getOutcomesRequest = new GetWorkflowOutcomesRequest(workflowIds[0]);
